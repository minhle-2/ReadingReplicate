...
label variable ""z
eststo EW_iv1: reghdfe birth_rate $dist_int_1878 $mar_int_1878 birth_rate_lagged articles_ownXpost [aweight=total_pop_1871] if inrange(year,1873,1878) & comparison_75_80==1, absorb(year dist_code regionXyearfes) cluster(dist_code) first
...
esttab EW_iv1 using "$results/T5_EW_IV", stats(r2_within) b(%10.3f) se(%9.3f) star(* 0.10 ** 0.05 *** 0.01) tex replace
